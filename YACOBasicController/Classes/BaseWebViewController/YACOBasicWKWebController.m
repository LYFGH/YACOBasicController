...
{
    if (!_myWebView) {
        _myWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0.f, kYACOScreenWidth, kYACOScreenHeight) configuration:self.configuration];
...
{
    if (!_progressView) {
        _progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0, 0.f, kYACOScreenWidth, 2.f)];
